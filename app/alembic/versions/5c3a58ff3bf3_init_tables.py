...
Revision ID: 5c3a58ff3bf3
Revises:
Create Date: 2025-09-10 13:20:20.536585
...
def upgrade() -> None:
    ...
    op.create_index("idx_product_items_gin", "product_items", ["attributes"], unique=False, postgresql_using="gin")
...
def downgrade() -> None:
    ...
    op.drop_index("idx_product_items_gin", table_name="product_items", postgresql_using="gin")
